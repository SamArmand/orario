...
urlpatterns = patterns('',
        ...
        url(r'^schedule/(\d+)/course/(\d+)/delete/$', 'scheduler.views.delete_course', name='course-delete'),
        url(r'^schedule/(\d+)/section/$', 'scheduler.views.section', name='section'),
        url(r'^schedule/(\d+)/section/(\d+)/delete/$', 'scheduler.views.delete_section', name='section-delete'),
        url(r'^schedule/(\d+)/generate/$', 'scheduler.views.generate', name='generate'),
        url(r'^schedule/(\d+)/auto/$', 'scheduler.views.auto_generate', name='auto-generate'),
)
